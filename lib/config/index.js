...
const isConfigComplete = config => config.command === "bust" && config.directives && config.directives.length > 0 || config.command === "restore" && config.directives && config.directives.length > 0 && config.options;
