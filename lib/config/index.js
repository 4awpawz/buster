...
const config = (configParams) => {
    ...
    if (isConfigComplete(mergeConfigs(mergeConfigs(defConfig, clConfig), configParams))) {
        console.log("using params configuration");
        return mergeConfigs(mergeConfigs(mergeConfigs(defConfig, clConfig), configParams));
    }
